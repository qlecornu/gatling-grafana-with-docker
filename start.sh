...
docker exec -it --user root grafana grafana-cli --pluginUrl https://downloads.gatling.io/releases/frontline-grafana-bundle/1.16.4/frontline-grafana-bundle-1.16.4-bundle.zip plugins install frontline
